...
The CoreThink Code CLI can be fully configured using environment variables, allowing you to run it in ephemeral environments without a `config.json` file.
