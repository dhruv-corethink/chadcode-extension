# CoreThink Code CLI - Docker

A containerized version of the CoreThink Code CLI with full browser automation support.
...
Mount your existing CoreThink Code configuration to avoid setup prompts:
