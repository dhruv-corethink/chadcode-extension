...
This document demonstrates how to run CoreThink Code CLI in a Docker container using only environment variables, without requiring a config.json file.
...
# Install CoreThink Code CLI globally
...
jobs:
    code-review:
        ...
        steps:
            ...
            - name: Install CoreThink Code CLI
              run: npm install -g @kilocode/cli
...
This will run CoreThink Code CLI in a completely ephemeral environment without any persistent configuration files.
