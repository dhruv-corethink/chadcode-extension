...
The CoreThink Code documentation site is a mature, production-ready Docusaurus project that serves as the comprehensive documentation hub for the CoreThink Code VS Code extension. The site is hosted at https://kilo.ai/docs and provides extensive documentation covering installation, usage, features, and extension capabilities.
...
- **Using CoreThink Code**: Chat interface, modes, context mentions, and basic features
...
- **Extending CoreThink Code**: Model providers (18+ supported), local models, MCP integration, shell integration
