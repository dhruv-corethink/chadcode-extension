...
## How CoreThink Code Works

### Core Interaction Model

Users interact with CoreThink Code through a chat interface within VS Code, using natural language to describe what they want to accomplish. CoreThink Code then uses specialized modes and tools to fulfill requests.
...
CoreThink Code uses a sophisticated tool system organized into groups:
