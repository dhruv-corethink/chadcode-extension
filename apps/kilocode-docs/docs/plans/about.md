...
CoreThink Code accelerates development with AI-driven code generation and task automation. You can use CoreThink Code as an open source extension in VS Code or JetBrains IDEs.
...
CoreThink Code's paid plans, Teams and Enterprise, are the solution for these organizations.

:::note

Purchases of CoreThink Code's paid plans are separate from model provider credits.
