---
sidebar_position: 1
title: "Contributing to CoreThink Code"
---

# Contributing to CoreThink Code

CoreThink Code is an open-source project that welcomes contributions from developers of all skill levels. This guide will help you get started with contributing to CoreThink Code, whether you're fixing bugs, adding features, improving documentation, or sharing custom modes.

## Ways to Contribute

There are many ways to contribute to CoreThink Code:
...
Before diving into the code, we recommend reviewing the [Architecture Overview](/contributing/architecture) to understand how the different components of CoreThink Code fit together.
...
2. Go to the [CoreThink Code repository](https://github.com/Kilo-Org/kilocode)
...
Custom modes are a powerful way to extend CoreThink Code's capabilities. To create and share a custom mode:
...
When participating in the CoreThink Code community:
...
All contributors are valued members of the CoreThink Code community. Contributors are recognized in:

- Release notes
- The project's README
- The contributors list on GitHub

Thank you for contributing to CoreThink Code and helping make AI-powered coding assistance better for everyone!
