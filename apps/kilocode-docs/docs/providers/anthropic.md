...
# Using Anthropic With CoreThink Code
...
3.  **Create a Key:** Click "Create Key". Give your key a descriptive name (e.g., "CoreThink Code").
4.  **Copy the Key:** **Important:** Copy the API key _immediately_. You will not be able to see it again. Store it securely.

## Supported Models

CoreThink Code supports the following Anthropic Claude models:
