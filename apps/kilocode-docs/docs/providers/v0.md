...
# Using v0 With CoreThink Code

CoreThink Code supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with CoreThink Code through the familiar OpenAI API interface.

## Prerequisites

To use v0 with CoreThink Code, you'll need:
...
Setting up v0 in CoreThink Code is straightforward:

1. In CoreThink Code settings (click the <Codicon name="gear" /> icon):
...
<img src="/docs/img/providers/v0-setup.png" alt="v0 configuration in CoreThink Code settings" width="600" />
