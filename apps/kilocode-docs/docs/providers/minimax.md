...
# Using MiniMax With CoreThink Code
...
3. **Create a Key:** Click to generate a new API key and give it a descriptive name (e.g., “CoreThink Code”).
4. **Copy the Key:** Copy the key immediately. You may not be able to view it again. Store it securely.

## Supported Models

CoreThink Code supports the following MiniMax models:
