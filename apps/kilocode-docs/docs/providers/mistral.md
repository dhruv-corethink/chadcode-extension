...
# Using Mistral AI With CoreThink Code

CoreThink Code supports accessing models through the Mistral AI API, including both standard Mistral models and the code-specialized Codestral model.
...
CoreThink Code supports the following Mistral models:
...
The default model temperature in CoreThink Code is 0.0, so you should consider experimenting with [temperature adjustments](/features/model-temperature)!
