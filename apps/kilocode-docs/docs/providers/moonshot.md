...
# Using Moonshot.ai With CoreThink Code
...
3. **Create a Key:** Click to generate a new API key. Give it a descriptive name (e.g., "CoreThink Code").
4. **Copy the Key:** **Important:** Copy the API key _immediately_. Store it securely.

## Supported Models

CoreThink Code supports the following Moonshot.ai models:
