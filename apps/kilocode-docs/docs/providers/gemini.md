...
# Using Google Gemini With CoreThink Code

CoreThink Code supports Google's Gemini family of models through the Google AI Gemini API.
...
CoreThink Code supports the following Gemini models:
