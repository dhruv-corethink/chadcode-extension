...
# Using SAP AI Core With CoreThink Code

CoreThink Code supports accessing models through SAP AI Core, a service in the SAP Business Technology Platform that lets you efficiently run AI scenarios in a standardized, scalable, and hyperscaler-agnostic manner.
...
To use SAP AI Core with CoreThink Code, you'll need to create a service key for your SAP AI Core service instance:
...
CoreThink Code applies the following filters when fetching models:
...
3. Configure CoreThink Code with your credentials
