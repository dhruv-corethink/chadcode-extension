...
# Using Fireworks AI With CoreThink Code
...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "CoreThink Code").
...
CoreThink Code supports the following Fireworks AI models:
