...
# Using OpenRouter With CoreThink Code
...
OpenRouter supports a large and growing number of models. CoreThink Code automatically fetches the list of available models. Refer to the [OpenRouter Models page](https://openrouter.ai/models) for the complete and up-to-date list.
