...
# Using Inception With CoreThink Code
...
CoreThink Code supports Inception's available models. Model selection and capabilities may vary based on your account tier.
