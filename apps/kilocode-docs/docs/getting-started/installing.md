---
sidebar_label: Installing CoreThink Code
---

# Installing CoreThink Code

CoreThink Code brings AI-powered coding assistance directly to your editor. Install using one of these methods:
...
If you already have VS Code installed: [Click here to install CoreThink Code](vscode:extension/kilocode.Kilo-Code)
...
3. Search for "CoreThink Code"
4. Select "CoreThink Code" by CoreThink Code and click **Install**
5. Reload VS Code if prompted

After installation, find the CoreThink Code icon (<img src="/docs/img/kilo-v1.svg" width="12" />) in the Side Bar to open the CoreThink Code panel.

<img src="/docs/img/installing/installing.png" alt="VS Code marketplace with CoreThink Code extension ready to install" width="400" />
*VS Code marketplace with CoreThink Code extension ready to install*

## Cursor Marketplace

:::tip

If you already have Cursor installed: [Click here to install CoreThink Code](cursor:extension/kilocode.Kilo-Code)
...
For VS Code-compatible editors like VSCodium, Gitpod, Eclipse Theia, and Windsurf, you can browse and install directly from the [CoreThink Code page on Open VSX Registry](https://open-vsx.org/extension/kilocode/Kilo-Code).
...
4. Search for "CoreThink Code"
5. Select "CoreThink Code" and click **Install**
...
1. **Download the VSIX file:**
    ...
    - Find official releases on the [CoreThink Code GitHub Releases page](https://github.com/Kilo-Org/kilocode/releases)
...
*Installing CoreThink Code using VS Code's "Install from VSIX" dialog*

## JetBrains IDEs

CoreThink Code is also available as a plugin for JetBrains IDEs including IntelliJ IDEA, WebStorm, PyCharm, Android Studio, PhpStorm, RubyMine, CLion, GoLand, DataGrip, and Rider.

### Prerequisites

Before installing the CoreThink Code plugin, ensure you have:
...
3. **Search for CoreThink Code:**
    ...
    - Search for "CoreThink Code"

4. **Install the Plugin:**

    - Click **Install** on the CoreThink Code plugin
...
6. **Find CoreThink Code:**
    - Look for the CoreThink Code icon in the right sidebar
    - Click to open the CoreThink Code panel
...
- Restart VS Code
- Verify CoreThink Code is listed and enabled in Extensions
- Try disabling and re-enabling the extension in Extensions
- Check Output panel for errors (View → Output, select "CoreThink Code")
