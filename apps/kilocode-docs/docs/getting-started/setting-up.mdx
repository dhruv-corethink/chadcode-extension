...
CoreThink Code provides a simple registration process that gives you access to the latest frontier coding models with your CoreThink Code login.

1. Click on "Try CoreThink Code for Free" in the extension
...
<img src="/docs/img/setting-up/signupflow.gif" alt="Sign up and registration flow with CoreThink Code" />
