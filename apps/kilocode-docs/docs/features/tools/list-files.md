...
The `list_files` tool displays the files and directories within a specified location. It helps CoreThink Code understand your project structure and navigate your codebase effectively.
...
- When CoreThink Code needs to understand your project structure
- When CoreThink Code explores what files are available before reading specific ones
- When CoreThink Code maps a codebase to better understand its organization
- Before using more targeted tools like `read_file` or `search_files`
- When CoreThink Code needs to check for specific file types (like configuration files) across a project
...
- When starting a new task, CoreThink Code may list the project files to understand its structure before diving into specific code.
- When asked to find specific types of files (like all JavaScript files), CoreThink Code first lists directories to know where to look.
- When providing recommendations for code organization, CoreThink Code examines the current project structure first.
- When setting up a new feature, CoreThink Code lists related directories to understand the project conventions.
