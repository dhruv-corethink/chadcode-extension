...
## MCP in CoreThink Code

CoreThink Code implements the Model Context Protocol to:
...
- [Using MCP in CoreThink Code](/features/mcp/using-mcp-in-kilo-code) - Get started with MCP in CoreThink Code, including creating simple servers
