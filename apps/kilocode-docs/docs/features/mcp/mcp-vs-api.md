...
## Why CoreThink Code Uses MCP

CoreThink Code leverages MCP to provide:
...
MCP creates a universal connector between CoreThink Code and external services, with REST APIs often powering those services behind the scenes.
