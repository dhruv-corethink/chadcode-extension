...
Historically, CoreThink Code has relied on XML-style function and tool definitions embedded in the system prompt to inform the model about tools available to accomplish tasks. The model was given instructions and examples about how to use these tools:
...
CoreThink Code recently implemented _experimental_ support for native function calling in 4.106.0.
...
1. Ensure you are using a provider that has been enabled in CoreThink Code for this experiment. As of Oct 21, 2025, they include:
