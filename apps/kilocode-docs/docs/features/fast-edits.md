...
Fast Edits (using the "Enable editing through diffs" setting) is enabled by default in CoreThink Code. You typically don't need to change these settings unless you encounter specific issues or want to experiment with different diff strategies.
:::

CoreThink Code offers an advanced setting to change how it edits files, using diffs (differences) instead of rewriting entire files. Enabling this feature provides significant benefits.
...
When **Enable editing through diffs** is checked:
    ...
    <img src="/docs/img/fast-edits/fast-edits-5.png" alt="CoreThink Code settings showing Enable editing through diffs" width="500" />
...
This slider controls how closely the code sections identified by the AI must match the actual code in your file before a change is applied.
    ...
    <img src="/docs/img/fast-edits/fast-edits-4.png" alt="CoreThink Code settings showing Enable editing through diffs checkbox and Match precision slider" width="500" />
