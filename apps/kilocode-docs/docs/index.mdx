...
# CoreThink Code Documentation

CoreThink Code **accelerates** development with AI-driven code generation and task automation. This open source extension plugs directly into VS Code.
...
1. [Install CoreThink Code](/getting-started/installing)
2. [Set up CoreThink Code](/getting-started/setting-up)
...
<Image
  ...
  alt="GIF showing some of the capabilities of CoreThink Code"
  width="600"
/>

### Basics

Use [the chat interface](/basic-usage/the-chat-interface) to tell CoreThink Code what you need. It relies on coding‑optimized AI models to complete each request.
...
### Using CoreThink Code

#### Multiple Modes

CoreThink Code adapts to your needs with specialized [modes](/basic-usage/using-modes):
...
CoreThink Code comes with powerful [tools](/features/tools/tool-use-overview) that can:
...
- **[Local Models](/advanced-usage/local-models):** Run CoreThink Code with local AI models for offline use or enhanced privacy

### Customizing CoreThink Code

Make CoreThink Code work your way with:
...
- [Using CoreThink Code](/basic-usage/the-chat-interface) - Learn the basics
...
- **YouTube:** <a href={YOUTUBE_URL} target="_blank">Check out our YouTube</a> to learn hands on skills when using CoreThink Code
...
Ready to get started? Click the **Next** button below to begin your journey with CoreThink Code!
