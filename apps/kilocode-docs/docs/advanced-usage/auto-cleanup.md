...
As you work with CoreThink Code, each task creates files containing conversation history, checkpoints, and other data. Over time, this accumulates and can consume significant disk space. Auto-Cleanup solves this by:
...
Access Auto-Cleanup settings through the CoreThink Code settings panel:

1. Click the gear icon (<i class="codicon codicon-gear"></i>) in CoreThink Code
