...
The Agent Manager is a dedicated control panel for running and supervising CoreThink Code agents as interactive CLI processes. It supports:
...
- Install/update the CoreThink Code CLI (latest) — see [CLI setup](/cli)
- Open a project in VS Code (workspace required)

## Opening the Agent Manager

- Command Palette: “CoreThink Code: Open Agent Manager”
- Or use the title/menu entry if available in your CoreThink Code UI
