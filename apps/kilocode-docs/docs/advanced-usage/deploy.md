...
Kilo Deploy lets you ship **Next.js** applications directly from CoreThink Code, with:

- **One-click deployment** from the CoreThink Code dashboard
...
- You must enable the **GitHub Integration**
    ...
    - Click **Configure** and follow the prompts to connect GitHub to CoreThink Code

Deploy supports all major package managers: **npm, pnpm, yarn, bun**. CoreThink Code automatically detects which one your project uses and runs the correct build command.
