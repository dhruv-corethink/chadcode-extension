...
# Using CoreThink Code for Free and on a Budget

**Why this matters:** AI model costs can add up quickly during development. This guide shows you how to use CoreThink Code effectively while minimizing or eliminating costs through free models, budget-friendly alternatives, and smart usage strategies.

## Completely Free Options

### Grok Code Fast 1

This frontier AI model is 100% free in CoreThink Code for a limited time. [See the blog post for more details](https://blog.kilo.ai/p/grok-code-fast-get-this-frontier-ai-model-free).
...
3. Configure CoreThink Code with the OpenRouter provider
...
2. **Configure multiple providers** in CoreThink Code
