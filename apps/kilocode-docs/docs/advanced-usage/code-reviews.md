...
- **CoreThink Code credits are still used** when the agent performs model reasoning during a review.

---

## How to Use

1. Go to the **Review Agent** section in your CoreThink Code [personal](https://app.kilo.ai/profile) or [Organization](https://app.kilo.ai/organizations) dashboard.
