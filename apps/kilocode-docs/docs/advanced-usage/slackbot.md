...
The Kilo Slackbot brings the power of CoreThink Code directly into your Slack workspace. Ask questions about your repositories, request code implementations, or get help with issues—all without leaving Slack.
...
- You must have a **CoreThink Code account** with available credits
...
3. **AI generates a response** — CoreThink Code's AI analyzes your request and provides helpful responses
...
- **CoreThink Code credits are used** when the Slackbot performs work (model usage, operations, etc.)
- Credit usage is similar to using CoreThink Code through other interfaces
