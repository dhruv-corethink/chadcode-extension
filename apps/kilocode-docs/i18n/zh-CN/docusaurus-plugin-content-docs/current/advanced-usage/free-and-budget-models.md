...
# 免费和低成本使用 CoreThink Code

**为什么这很重要：** 在开发过程中，AI 模型成本可能会迅速累积。本指南展示了如何通过免费模型、经济实惠的替代方案和智能使用策略，在最小化或消除成本的同时有效使用 CoreThink Code。

## 完全免费的选项

### Grok Code Fast 1

这款前沿 AI 模型在 CoreThink Code 中限时 100% 免费。[查看博客文章了解更多信息](https://blog.kilo.ai/p/grok-code-fast-get-this-frontier-ai-model-free)。
...
2. 从仪表板获取你的 API 密钥
3. 使用 OpenRouter 供应商配置 CoreThink Code
