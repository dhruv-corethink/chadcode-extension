...
# CoreThink Code 模型选择指南

最后更新：2025年9月3日。

AI 模型领域发展迅速，因此本指南重点介绍目前在 CoreThink Code 中表现优异的模型。我们会定期更新，以反映新模型的出现和性能变化。

## CoreThink Code 表现最佳者
...
AI 模型领域变化迅速，要保持更新，请查看 [**👉 CoreThink Code 在 OpenRouter 上的社区最爱**](https://openrouter.ai/apps?url=https%3A%2F%2Fkilocode.ai%2F)
