...
1. **Fork 并克隆仓库**：
    ...
    - **Fork 仓库**：
        - 访问 [CoreThink Code GitHub 仓库](https://github.com/Kilo-Org/kilocode)
...
2. 这将打开一个新的 VSCode 窗口，并加载 CoreThink Code
...
- 检查 VSCode 中的输出面板（View > Output）并从下拉菜单中选择 "CoreThink Code"
